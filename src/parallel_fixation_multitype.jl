...
## parallel_fixation_multitype.jl
##
...
## and strategies at an arbitrary point on the simplex.
## This output corresponds to supplementary figures 3-6.
    ...
    @everywhere function run_worker(inputs, results)
        ...
        while true
			...
			for g in 1:runs_per_trial
				...
				# if a discriminator exists, randomly make one a follower
				# else, make a discriminator and make it a follower
...
main(["--input", "submit/fixation_paper_multitype.json"])
